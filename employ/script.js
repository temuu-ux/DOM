...
const cards = () => {
  employees.map((employees) => {
    let employeesName = document.createElement("div");
    ...
    employeesName.innerText = "Name: " + employees.name;
    position.innerText = "Position: " + employees.position;
    salary.innerText = "Salary: " + employees.salary;
    department.innerText = "Department: " + employees.department;
    performanceRating.innerText =
      "PerfotmanceRating: " + employees.performanceRating;

    root.appendChild(employeesName);
